        ...
        if ssh:
            try:
                ...
                commands = [
                    ...
                    ("sudo apt install -y python3-pip python3-dev sqlite3", "Install Python, pip, and SQLite"),
                    ...
                    # Enable Nginx site
                    ("sudo ln -s /etc/nginx/sites-available/Royalty-Travel /etc/nginx/sites-enabled", "Enable Nginx site"),
